 ...
 */
final class Version20221111124101 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE courier_arriver (id INT NOT NULL, controleurs_id INT DEFAULT NULL, expediteur VARCHAR(255) DEFAULT NULL, date_correspondance VARCHAR(255) DEFAULT NULL, numero_correspondance VARCHAR(255) DEFAULT NULL, date_reponse VARCHAR(255) DEFAULT NULL, numero_reponse VARCHAR(255) DEFAULT NULL, etat VARCHAR(255) DEFAULT NULL, statut VARCHAR(255) DEFAULT NULL, type_de_courrier VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_279DD143E3D7B207 (numero_correspondance), UNIQUE INDEX UNIQ_279DD14399E2C066 (numero_reponse), INDEX IDX_279DD14390C7B3D2 (controleurs_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE courier_depart (id INT NOT NULL, destination VARCHAR(255) DEFAULT NULL, nombre_piece VARCHAR(255) NOT NULL, numero_archive VARCHAR(255) DEFAULT NULL, observation VARCHAR(255) DEFAULT NULL, numero_ordre VARCHAR(255) DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_B8313FC113A8433D (numero_archive), UNIQUE INDEX UNIQ_B8313FC1DC26B9F4 (numero_ordre), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, profil_id INT DEFAULT NULL, username VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, matricule VARCHAR(255) DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, date_de_naissance VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, date VARCHAR(255) NOT NULL, dtype VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), UNIQUE INDEX UNIQ_8D93D64912B2DC9C (matricule), UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649275ED078 (profil_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
