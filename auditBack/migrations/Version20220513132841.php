 ...
 */
final class Version20220513132841 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE courier (id INT AUTO_INCREMENT NOT NULL, rapport_id INT DEFAULT NULL, assistante_id INT DEFAULT NULL, coordinateur_id INT DEFAULT NULL, controleur_id INT DEFAULT NULL, numero_courier VARCHAR(255) NOT NULL, object VARCHAR(255) NOT NULL, dtype VARCHAR(255) NOT NULL, INDEX IDX_CF134C7C1DFBCC46 (rapport_id), INDEX IDX_CF134C7CA2561908 (assistante_id), INDEX IDX_CF134C7CD32E46EA (coordinateur_id), INDEX IDX_CF134C7CB13E6101 (controleur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
